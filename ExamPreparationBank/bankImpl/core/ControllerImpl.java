...
import static bank.common.ExceptionMessages.INVALID_BANK_TYPE;
...
public class ControllerImpl implements Controller{
   ...
   private Map <String, Bank> banks;
    ...
    public String addBank(String type, String name) {
        ...
        return String.format(SUCCESSFULLY_ADDED_BANK_OR_LOAN_TYPE);
    }
    ...
    public String finalCalculation(String bankName) {
        Bank bank = banks.get(bankName);
        double funds = bank.getLoans().stream().mapToDouble(Loan::getAmount).sum()
                +bank.getClients().stream().mapToDouble(Client-> Client.getIncome()).sum();
